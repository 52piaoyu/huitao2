    ...
    public function sort()
    {
       ...
       // $filter_rule_sql = $this->_create_filter_rule();
        ...
        if (count($num_iid_list)) {
            ...
            if (!count($repeat_num_iid)) {
                $repeat_num_iid=array('0');
            }
            ...
            return ssreturn(0, date("Y-m-d H:i:s").":no past data.", 1, 1);
        }//echo date("Y-m-d H:i:s").":no past data.\r\n";
    }
    //更新排序表
